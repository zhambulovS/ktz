                    ...
                    <div class="bg-white p-4 p-md-5 rounded shadow-sm">
                        ...
                        <form action="{{route('login.post', ['locale' => app()->getLocale()])}}" method="POST">
                            ...
                            <div class="row gy-3 gy-md-4 overflow-hidden">
                                ...
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button class="btn btn-lg btn-primary" type="submit">@lang('lang.login')</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                    <a href="{{route('register', ['locale' => app()->getLocale()])}}" class="link-secondary text-decoration-none">@lang('lang.register')</a>
                                    <a href="#!" class="link-secondary text-decoration-none">@lang('lang.forget_pass')</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
